    ...
    useEffect(() => {
        ...
        meshes.map((item) => {
            let a = {
                ...
                minPolarAngle: item.userData?.minPolarAngle ?? 0,
                maxPolarAngle: item.userData?.maxPolarAngle ?? 180,
                minAzimuthAngle: item.userData?.minAzimuthAngle ?? -180,
                maxAzimuthAngle: item.userData?.maxAzimuthAngle ?? 180,
